...
<head>
    ...
    <title>Lupa Kata Sandi - GPL Express</title>
    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            <a href="{{ route('home') }}" class="inline-flex items-center justify-center space-x-3 mb-6">
                ...
                <div class="text-left">
                    <h2 class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#F4C430] to-[#E6B020]">Lupa Kata Sandi</h2>
                    <p class="text-sm text-slate-500">Masukkan email untuk reset password</p>
                </div>
            </a>
        </div>
