...
@section('title', 'Assign Kurir Delivery - GPL Express')
@section('page-title', 'Assign Kurir Delivery')

@section('content')
<div>
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 lg:mb-8">
        <div>
            <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Assign Kurir Delivery</h1>
            <p class="text-sm text-gray-600 mt-1">Assign paket ke kurir delivery untuk pengantaran dan penagihan COD</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.shipments.destination-courier.assign') }}" id="assignDestinationCourierForm">
        @csrf
        
        <!-- Select Courier -->
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">Pilih Kurir Delivery</h2>
            <select name="courier_id" id="courier_id" required
                ...
                <option value="">-- Pilih Kurir Delivery --</option>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-semibold text-gray-900">Paket yang Tersedia untuk Di-assign</h2>
            ...
            @if($shipments->isEmpty())
                <div class="text-center py-12">
                    <p class="text-gray-500">Tidak ada paket yang tersedia untuk di-assign ke kurir delivery.</p>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Kurir Linehaul</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($shipments as $shipment)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        @if($shipment->courier)
                                            <div class="text-sm text-gray-900">{{ $shipment->courier->name }}</div>
                                        @else
...
document.getElementById('assignDestinationCourierForm').addEventListener('submit', function(e) {
    ...
    if (!courierId) {
        e.preventDefault();
        alert('Silakan pilih kurir delivery terlebih dahulu.');
        return false;
    }
