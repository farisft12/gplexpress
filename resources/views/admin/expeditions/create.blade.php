...
@section('title', 'Tambah Ekspedisi - GPL Express')
...
<div class="max-w-4xl mx-auto">
    <div class="mb-6 lg:mb-8">
        ...
        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Tambah Ekspedisi</h1>
    </div>

    <form method="POST" action="{{ route('admin.expeditions.store') }}" class="bg-white rounded-xl shadow-sm p-6 lg:p-8">
        @csrf
