...
<div class="max-w-4xl mx-auto">
    <div class="mb-6 lg:mb-8">
        ...
        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Tambah User</h1>
    </div>

    <form method="POST" action="{{ route('admin.users.store') }}" class="bg-white rounded-xl shadow-sm p-6 lg:p-8">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select id="role" name="role" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#F4C430] focus:border-transparent outline-none @error('role') border-red-500 @enderror">
